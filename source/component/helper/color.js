...
/**
 * hex转rgb。
 * @param { number[] } hex - [red, green, blue, alpha]，其中red、green、blue、alpha均属于[0, 255]。
 * @returns { number[] } - [red, green, blue, alpha]，其中red、green、blue均属于[0, 255]，alpha属于[0, 1]。
 * @example
 ...
 * hex转hsl。
 * @param { number[] } hex - [red, green, blue, alpha]，其中red、green、blue、alpha均属于[0, 255]。
 * @returns { number[] } - [hue, saturation, lightness, alpha]，其中hue属于[0, 360]，saturation属于[0, 1]（代表[0%, 100%]），lightness属于[0, 1]（代表[0%, 100%]），alpha属于[0, 1]。
 * @example
...
/**
 * rgb转hex。
 * @param { number[] } rgb - [red, green, blue, alpha]，其中red、green、blue均属于[0, 255]，alpha属于[0, 1]。
 * @returns { number[] } - [red, green, blue, alpha]，其中red、green、blue、alpha均属于[0, 255]。
 * @example
...
/**
 * hsl转hex。
 * @param { number[] } hsl - [hue, saturation, lightness, alpha]，其中hue属于[0, 360]，saturation属于[0, 1]（代表[0%, 100%]），lightness属于[0, 1]（代表[0%, 100%]），alpha属于[0, 1]。
 * @returns { number[] } - [red, green, blue, alpha]，其中red、green、blue、alpha均属于[0, 255]。
 * @example
