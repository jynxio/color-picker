...
function Output ( props ) {
    ...
    const [ getCopyStyle, animateCopyStyle ] = createAnimatedStyle();
    const [ getOutputStyle, animateOutputStyle ] = createAnimatedStyle();
    const [ getPaletteStyle, animatePaletteStyle ] = createAnimatedStyle();
        ...
        <div class={ style.output }>
            ...
            <div class={ style.controller } style={ { "border-color": getBorderColor() } }>
                ...
                <button
                    ...
                    onPointerDown={ handleSwitchOutputFormatEvent }
                >
                ...
                <button
                    ...
                    onPointerDown={ handleSwitchPaletteFormatEvent }
                >
...
function createAnimatedStyle () {
    ...
    const [ getStrength, setStrength ] = createSignal( 0 );
    ...
    const getStyle = _ => {
        ...
        const font_color = getStrength();
        const background_color = 255 - getStrength();

        return {
            "color": `rgb( ${ font_color } ${ font_color } ${ font_color } / 1 )`,
            "background-color": `rgb( ${ background_color } ${ background_color } ${ background_color } / 1 )`,
        };

    };

    return [ getStyle, animateStyle ];
